...
# https://huggingface.co/bert-base-uncased?library=true
# sentiment_model = pipeline("fill-mask", model="bert-base-uncased")
sentiment_model = pipeline("text-classification", model="bert-base-uncased")
...
if os.path.isfile('Src/BERT/DistilBERT/shoe_cleanData_semantic.csv'):
